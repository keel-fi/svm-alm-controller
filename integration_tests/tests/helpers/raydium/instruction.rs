/* NOTE: this is modified copy/pasta from https://github.com/raydium-io/raydium-amm/blob/master/program/src/instruction.rs */
...
use crate::helpers::spl::{ASSOCIATED_TOKEN_PROGRAM_ID, SPL_TOKEN_PROGRAM_ID};

use super::{AmmParams, Fees, LastOrderDistance, SimulateParams};

// Raydium Legacy offset by 1 due to the instruction discriminator.
pub const RAYDIUM_LEGACY_AMM_SWAP_BASE_IN_AMOUNT_IN_OFFSET: u16 = 1;
