/* NOTE: this is modified copy/pasta from https://github.com/raydium-io/raydium-amm/blob/master/program/src/state.rs */
...
impl Fees {
    /// Initializes fees to 0 for easier math
    pub fn initialize() -> Self {
        Self {
            // min_separate = 0/10000
            min_separate_numerator: 0,
            min_separate_denominator: TEN_THOUSAND,
            // trade_fee = 0/10000
            trade_fee_numerator: 0,
            trade_fee_denominator: TEN_THOUSAND,
            // pnl = 0/100
            pnl_numerator: 0,
            pnl_denominator: 100,
            // swap_fee = 0 / 10000
            swap_fee_numerator: 0,
            swap_fee_denominator: TEN_THOUSAND,
        }
    }
}
...
impl StateData {
    pub fn initialize(open_time: u64) -> Self {
        Self {
            need_take_pnl_coin: 0u64,
            need_take_pnl_pc: 0u64,
            total_pnl_pc: 0u64,
            total_pnl_coin: 0u64,
            pool_open_time: open_time,
            padding: Zeroable::zeroed(),
            orderbook_to_init_time: 0u64,
            swap_coin_in_amount: 0u128,
            swap_pc_out_amount: 0u128,
            swap_acc_pc_fee: 0u64,
            swap_pc_in_amount: 0u128,
            swap_coin_out_amount: 0u128,
            swap_acc_coin_fee: 0u64,
        }
    }
}
...
impl AmmInfo {
    pub fn to_bytes(&self) -> [u8; 752] {
        // Copy/pasta from original state.rs tests
        // serialize original data
        let mut pool_data = [0u8; 752];
        let mut offset = 0;
        pool_data[offset..offset + 8].copy_from_slice(&self.status.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.nonce.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.order_num.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.depth.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.coin_decimals.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.pc_decimals.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.state.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.reset_flag.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.min_size.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.vol_max_cut_ratio.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.amount_wave.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.coin_lot_size.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.pc_lot_size.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.min_price_multiplier.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.max_price_multiplier.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.sys_decimal_value.to_le_bytes());
        offset += 8;

        pool_data[offset..offset + 8]
            .copy_from_slice(&self.fees.min_separate_numerator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.fees.min_separate_denominator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.fees.trade_fee_numerator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.fees.trade_fee_denominator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.fees.pnl_numerator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.fees.pnl_denominator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.fees.swap_fee_numerator.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.fees.swap_fee_denominator.to_le_bytes());
        offset += 8;

        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.need_take_pnl_coin.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.need_take_pnl_pc.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.state_data.total_pnl_pc.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.total_pnl_coin.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.pool_open_time.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.state_data.padding[0].to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.state_data.padding[1].to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.orderbook_to_init_time.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 16]
            .copy_from_slice(&self.state_data.swap_coin_in_amount.to_le_bytes());
        offset += 16;
        pool_data[offset..offset + 16]
            .copy_from_slice(&self.state_data.swap_pc_out_amount.to_le_bytes());
        offset += 16;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.swap_acc_pc_fee.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 16]
            .copy_from_slice(&self.state_data.swap_pc_in_amount.to_le_bytes());
        offset += 16;
        pool_data[offset..offset + 16]
            .copy_from_slice(&self.state_data.swap_coin_out_amount.to_le_bytes());
        offset += 16;
        pool_data[offset..offset + 8]
            .copy_from_slice(&self.state_data.swap_acc_coin_fee.to_le_bytes());
        offset += 8;

        pool_data[offset..offset + 32].copy_from_slice(&self.coin_vault.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.pc_vault.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.coin_vault_mint.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.pc_vault_mint.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.lp_mint.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.open_orders.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.market.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.market_program.to_bytes());
        offset += 32;
        pool_data[offset..offset + 32].copy_from_slice(&self.target_orders.to_bytes());
        offset += 32;
        pool_data[offset..offset + 8 * 8].copy_from_slice(&[0u8; 8 * 8]);
        offset += 8 * 8;
        pool_data[offset..offset + 32].copy_from_slice(&self.amm_owner.to_bytes());
        offset += 32;
        pool_data[offset..offset + 8].copy_from_slice(&self.lp_amount.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.client_order_id.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.recent_epoch.to_le_bytes());
        offset += 8;
        pool_data[offset..offset + 8].copy_from_slice(&self.padding2.to_le_bytes());
...
impl AmmConfig {
    pub fn to_bytes(&self) -> [u8; mem::size_of::<AmmConfig>()] {
        let mut data = [0u8; mem::size_of::<AmmConfig>()];
        let mut offset = 0;
        data[offset..offset + 32].copy_from_slice(&self.pnl_owner.to_bytes());
        offset += 32;
        data[offset..offset + 32].copy_from_slice(&self.cancel_owner.to_bytes());
        offset += 32;
        for i in 0..28 {
            data[offset..offset + 8].copy_from_slice(&self.pending_1[i].to_le_bytes());
            offset += 8;
        }
        for i in 0..31 {
            data[offset..offset + 8].copy_from_slice(&self.pending_2[i].to_le_bytes());
            offset += 8;
        }
        data[offset..offset + 8].copy_from_slice(&self.create_pool_fee.to_le_bytes());
        data
    }
}
