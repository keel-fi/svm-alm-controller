...
mod tests {
    ...
    #[test_case(false, false, false, false, false, false, false, false, false ; "Can manage permissions")]
    #[test_case(false, false, false, false, false, false, false, false, false ; "Can invoke external transfer")]
    #[test_case(false, false, false, false, true, false, false, false, false ; "Can reallocate")]
    ...
    fn test_initialize_reserve_fails_without_permission(
        ...
        let permission_authority = Keypair::new();

        airdrop_lamports(&mut svm, &permission_authority.pubkey(), 1_000_000_000)?;
        ...
        let txn = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&permission_authority.pubkey()),
            &[&super_authority, &permission_authority],
            svm.latest_blockhash(),
        );
        let tx_result = svm.send_transaction(txn);
