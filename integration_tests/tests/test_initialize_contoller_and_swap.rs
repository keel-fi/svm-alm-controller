...
use svm_alm_controller_client::types::{ControllerStatus,PermissionStatus, IntegrationConfig, IntegrationStatus, SplTokenSwapConfig};
...
mod tests {
    ...
    use crate::{helpers::constants::NOVA_TOKEN_SWAP_PROGRAM_ID, subs::{initialize_swap, pull_integration}};
    ...
    fn initialize_controller_and_token_swap() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let usdc_external_integration_pk = initialize_integration(
            ...
            1_000_000_000_000, // rate_limit_slope
            1_000_000_000_000, // rate_limit_max_outflow
            &IntegrationConfig::SplTokenSwap(
                SplTokenSwapConfig {
