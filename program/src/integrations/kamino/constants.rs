...
pub const INIT_OBLIGATION_DISCRIMINATOR: [u8; 8] =
    anchor_discriminator("global", "init_obligation");
pub const INIT_METADATA_DISCRIMINATOR: [u8; 8] =
    anchor_discriminator("global", "init_user_metadata");
pub const INIT_OBLIGATION_FARM_DISCRIMINATOR: [u8; 8] =
    anchor_discriminator("global", "init_obligation_farms_for_reserve");
pub const DEPOSIT_LIQUIDITY_V2_DISCRIMINATOR: [u8; 8] = anchor_discriminator(
    "global",
    "deposit_reserve_liquidity_and_obligation_collateral_v2",
);
pub const WITHDRAW_OBLIGATION_V2_DISCRIMINATOR: [u8; 8] = anchor_discriminator(
    "global",
