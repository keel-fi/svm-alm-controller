...
pub fn process_instruction(
    ...
    match discriminator {
        ...
        2 => process_manage_controller(program_id, accounts, instruction_data),
        3 => process_manage_permission(program_id, accounts, instruction_data),
        4 => process_initialize_reserve(program_id, accounts, instruction_data),
        5 => process_manage_reserve(program_id, accounts, instruction_data),
        6 => process_initialize_integration(program_id, accounts, instruction_data),
        7 => process_manage_integration(program_id, accounts, instruction_data),
        8 => process_sync_reserve(program_id, accounts, instruction_data),
        9 => process_sync_integration(program_id, accounts, instruction_data),
        10 => process_push(program_id, accounts, instruction_data),
        11 => process_pull(program_id, accounts, instruction_data),
