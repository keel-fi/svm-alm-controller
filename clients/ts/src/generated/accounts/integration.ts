...
export function getIntegrationEncoder(): Encoder<IntegrationArgs> {
...
export function getIntegrationDecoder(): Decoder<Integration> {
...
export function getIntegrationCodec(): Codec<IntegrationArgs, Integration> {
