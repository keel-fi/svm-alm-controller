...
export type AtomicSwapBorrowInstruction<
  ...
  TAccountRecipientTokenAccountA extends string | IAccountMeta<string> = string,
  TAccountRecipientTokenAccountB extends string | IAccountMeta<string> = string,
...
export function getAtomicSwapBorrowInstructionDataEncoder(): Encoder<AtomicSwapBorrowInstructionDataArgs> {
...
export function getAtomicSwapBorrowInstructionDataDecoder(): Decoder<AtomicSwapBorrowInstructionData> {
...
export function getAtomicSwapBorrowInstructionDataCodec(): Codec<
